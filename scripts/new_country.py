...
def scaffold(destination: dict, region_label: str) -> dict:
    ...
    return {
        ...
        "signatureFacts": [
            {"topicKey": "", "label": "", "value": "", "note": "", "icon": ""}
            for _ in range(3)
        ],
...
def main() -> int:
    ...
    print("Content QA v3 locked: Travel Scale uses day notation with an open-ended final tier; Signature Facts / Beyond the Scenery / Travel Trivia must use distinct canonical topics.")
